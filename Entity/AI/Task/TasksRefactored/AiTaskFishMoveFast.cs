...
namespace Vintagestory.GameContent
{
    ...
    /// </summary>
    public class AiTaskFishMoveFastR : AiTaskBaseR
    {
        ...
        public AiTaskFishMoveFastR(EntityAgent entity, JsonObject taskConfig, JsonObject aiConfig) : base(entity, taskConfig, aiConfig)
        {
            float wanderRangeMin = 3;
            float wanderRangeMax = 30;
