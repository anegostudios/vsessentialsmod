...
{
    public class AiTaskFishOutOfWaterR : AiTaskBaseR
    {
        ...
        public AiTaskFishOutOfWaterR(EntityAgent entity, JsonObject taskConfig, JsonObject aiConfig) : base(entity, taskConfig, aiConfig)
        {
