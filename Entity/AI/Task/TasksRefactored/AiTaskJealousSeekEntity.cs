...
{
    public class AiTaskJealousSeekEntityR : AiTaskSeekEntityR
    {
        Entity guardedEntity;

        public AiTaskJealousSeekEntityR(EntityAgent entity, JsonObject taskConfig, JsonObject aiConfig) : base(entity, taskConfig, aiConfig)
        {
        }
