...
public class AiTaskSeekFoodAndEatR : AiTaskBaseR
{
    ...
    public override bool ShouldExecute()
    {
        ...
        {
            partitionUtil.WalkEntities(entity.Pos.XYZ, Config.LooseItemsSearchRange, target =>
            {
        ...
        {
            targetPoi = poiRegistry.GetNearestPoi(entity.Pos.XYZ, Config.PoiSearchRange, poi =>
            {
    ...
    public override bool ContinueExecute(float dt)
    {
        ...
        cuboidBuffer.Set(entity.SelectionBox.ToDouble().Translate(entity.Pos.X, entity.Pos.Y, entity.Pos.Z));
