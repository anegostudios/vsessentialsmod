...
namespace Vintagestory.GameContent
{
    ...
    public class AiTaskMeleeAttack : AiTaskBaseTargetable
    {
        ...
        public override bool ContinueExecute(float dt)
        {
            ...
            EntityPos own = entity.Pos;
            EntityPos his = targetEntity.Pos;
            ...
            if (turnToTarget)
            {
                ...
                entity.Pos.Yaw += GameMath.Clamp(yawDist, -curTurnRadPerSec * dt * GlobalConstants.OverallSpeedMultiplier, curTurnRadPerSec * dt * GlobalConstants.OverallSpeedMultiplier);
