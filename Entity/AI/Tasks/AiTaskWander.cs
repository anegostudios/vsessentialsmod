    ...
    public class AiTaskWander : AiTaskBase
    {
        ...
        public Vec3d loadNextWanderTarget()
        {
                ...
                switch (habitat)
                {
                    ...
                    case EnumHabitat.Land:
                        ...
                        else
                        {
                            ...
                            Vec3d startAhead = entity.Pos.XYZ.Ahead(1, 0, angleHor); // Otherwise they are forever stuck if they stand over the edge
            ...
            if (bestTarget.W > 0)
            {
                ...
                //bestTarget.Y += 1;
                //dx = bestTarget.X - entity.Pos.X;
                //dz = bestTarget.Z - entity.Pos.Z;
        ...
        public override bool ShouldExecute()
        {
            ...
            if (StayCloseToSpawn)
            {
                double dist = entity.Pos.XYZ.SquareDistanceTo(SpawnPosition);
                ...
                if (dist > MaxDistanceToSpawn * MaxDistanceToSpawn)
                {
                    ...
                    if (ellapsedMs - lastTimeInRangeMs > 1000 * 60 * 2 && entity.World.GetNearestEntity(entity.Pos.XYZ, 15, 15, (e) => e is EntityPlayer) == null)
                    {
                        needsToTele = true;
                    }
