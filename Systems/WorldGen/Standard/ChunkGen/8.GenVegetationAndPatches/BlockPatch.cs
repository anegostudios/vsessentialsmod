...
namespace Vintagestory.ServerMods.NoObf
{
    ...
    {
        public static int PatchesHashCode = BitConverter.ToInt32(SHA256.HashData("patches"u8.ToArray()));
        ...
        BlockPos tempPos = new BlockPos(Dimensions.NormalWorld);
        ...
        public void Generate(IBlockAccessor blockAccessor, IRandom rnd, int posX, int posY, int posZ, int firstBlockId, ActionBoolReturn<int, int> intersectsWith)
        {
            ...
            while (quantity-- > 0)
            {
                ...
                if (intersectsWith != null && intersectsWith(pos.X, pos.Z)) continue;
