                ...
                if (k > 0)
                {
                    ...
                    if (isDungeon)
                    {
                        ...
                        for (var index = 0; index < pathwaysSource.Count; index++)
                        {
                            ...
                            pathways.Add(new ConnectorMetaData(new FastVec3i(rotatedPos), path.Facing.GetHorizontalRotated(k * 90), k, path.Name, path.Targets, null));
                        }
